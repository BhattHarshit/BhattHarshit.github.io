---
title: "MA 114 — Introduction to Finite Mathematics with Applications"
...
1. **Waner & Costenoble**  
   _Finite Mathematics_, 6th ed. — delivered via **WebAssign**  
   Also accessible through [NC State Libraries](https://www.lib.ncsu.edu/borrow).  

2. **Recommended Tools**
   - [ZweigMedia Finite Math Toolkit](https://www.zweigmedia.com/tcpage.php?book=finite&lang=en&ed=6) — interactive matrix solvers, simplex animations, probability demos  
   - [Applied Finite Mathematics (Open Textbook)](https://open.umn.edu/opentextbooks/textbooks/applied-finite-mathematics) — full, free textbook aligned with MA 114 topics  
   - [Desmos Graphing Calculator](https://www.desmos.com/calculator) — for inequality visualization and LP regions  
   - [NC State Moodle](https://wolfware.ncsu.edu/) — access to WebAssign, grades, and announcements
...
<p class="text-gray-500 dark:text-gray-400 text-sm mt-8">This page summarizes the Spring 2024 version of MA 114. Policies and tools may evolve in future semesters.</p>
