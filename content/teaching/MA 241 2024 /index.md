...
1. **Franke, Griggs, & Norris**  
   _Calculus II for Engineers and Scientists_  
    Included as a PDF with [WebAssign](https://webassign.ncsu.edu/). You may also access at [NC State Libraries](https://www.lib.ncsu.edu/borrow).

2. **Recommended Learning Tools**
   - [Paul’s Online Math Notes – Calculus II](https://tutorial.math.lamar.edu/) — excellent topic breakdowns with examples  
   - [Desmos Scientific Calculator](https://www.desmos.com/scientific) — to visualize functions and series convergence  
   - [Khan Academy Calculus II](https://www.khanacademy.org/math/calculus-2) — structured video lessons  
   - [Symbolab](https://www.symbolab.com/) — step-by-step solutions for integrals and series (use as supplement, not substitute)  
   - [NC State Moodle (WolfWare)](https://wolfware.ncsu.edu/) — access homework, announcements, and grades
