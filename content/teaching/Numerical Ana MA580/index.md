...
1. **Ipsen, I. C. F.**  
   _Numerical Matrix Analysis_, SIAM, 2009  
   [Borrow from NCSU Library](https://catalog.lib.ncsu.edu/record/NCSU2514760)

2. **Kelley, C. T.**  
   _Iterative Methods for Linear and Nonlinear Equations_, SIAM, 1995  
   [Borrow from NCSU Library](https://catalog.lib.ncsu.edu/record/NCSU2512957)

3. **Higham, D. J. & Higham, N. J.**  
   _MATLAB Guide (2nd ed.)_, SIAM, 2005  
   [Borrow from NCSU Library](https://catalog.lib.ncsu.edu/record/NCSU3108706)

4. Some helpful notes from [Dr. Moody Chu](https://mtchu.math.ncsu.edu/Teaching/Lectures/lecture.html)
...
- Use [MathWorks MATLAB](https://www.mathworks.com/) for hands-on experimentation  
